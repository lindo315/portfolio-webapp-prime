        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="space-y-4 text-[#8892B0]">
              <p>
                Hello! I'm a passionate web developer who loves creating beautiful and functional digital experiences. 
                My journey in web development started during my computer science studies, where I discovered my love for 
                frontend development and user experience design.
              </p>
              <p>
                I specialize in building modern web applications using React, TypeScript, and Node.js. I'm always 
